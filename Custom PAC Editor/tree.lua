...
function PANEL:Paint(w,h)
	local blacktowhite = math.Clamp(math.sin(RealTime()*2)*255,0,255)
	local sine_black = Color(blacktowhite,blacktowhite,blacktowhite)
	surface.SetDrawColor(sine_black)
	for i=0, 1 - 1 do
